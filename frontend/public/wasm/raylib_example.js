...
function findWasmBinary() {
  return locateFile('raylib_example.wasm');
}
...
var ASM_CONSTS = {
  92333: () => { if (document.fullscreenElement) return 1; },  
 92379: () => { return Module.canvas.width; },  
 92411: () => { return parseInt(Module.canvas.style.width); },  
 92459: () => { document.exitFullscreen(); },  
 92486: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 92558: () => { if (document.fullscreenElement) return 1; },  
 92604: () => { return Module.canvas.width; },  
 92636: () => { return screen.width; },  
 92661: () => { document.exitFullscreen(); },  
 92688: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 92882: () => { return window.innerWidth; },  
 92908: () => { return window.innerHeight; },  
 92935: () => { if (document.fullscreenElement) return 1; },  
 92981: () => { return Module.canvas.width; },  
 93013: () => { return parseInt(Module.canvas.style.width); },  
 93061: () => { if (document.fullscreenElement) return 1; },  
 93107: () => { return Module.canvas.width; },  
 93139: () => { return screen.width; },  
 93164: () => { return window.innerWidth; },  
 93190: () => { return window.innerHeight; },  
 93217: () => { if (document.fullscreenElement) return 1; },  
 93263: () => { return Module.canvas.width; },  
 93295: () => { return screen.width; },  
 93320: () => { document.exitFullscreen(); },  
 93347: () => { if (document.fullscreenElement) return 1; },  
 93393: () => { return Module.canvas.width; },  
 93425: () => { return parseInt(Module.canvas.style.width); },  
 93473: () => { document.exitFullscreen(); },  
 93500: ($0) => { Module.canvas.style.opacity = $0; },  
 93538: () => { return screen.width; },  
 93563: () => { return screen.height; },  
 93589: () => { return window.screenX; },  
 93616: () => { return window.screenY; },  
 93643: () => { return window.devicePixelRatio; },  
 93679: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 93732: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 93783: () => { Module.canvas.style.cursor = 'none'; },  
 93820: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 94076: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 94127: () => { if (document.pointerLockElement) return 1; },  
 94174: () => { if (document.fullscreenElement) return 1; },  
 94220: () => { return window.innerWidth; },  
 94246: () => { return window.innerHeight; }
};
