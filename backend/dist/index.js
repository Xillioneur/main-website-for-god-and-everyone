...
async function getDivineCensus() {
    ...
    const tryPaths = [path_1.default.join(process.cwd(), 'backend/census.json'), path_1.default.join(__dirname, '../census.json'), path_1.default.join(__dirname, '../../backend/census.json')];
